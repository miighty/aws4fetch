(function (global, factory) {
  ...
  (global = global || self, factory(global.aws4fetchmiighty = {}, global.encoding));
  ...
  async function hmac(key, string, encoding$$1) {
    ...
    return encoding$$1 === "hex" ? buf2hex(signed) : signed;
  }

  async function hash(content, encoding$$1) {
    const digest = await crypto.subtle.digest(
      "SHA-256",
      typeof content === "string" ? encoder.encode(content) : content
    );
    return encoding$$1 === "hex" ? buf2hex(digest) : digest;
  }
